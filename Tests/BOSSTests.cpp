...
//   auto expr2 = boss::ComplexExpression(std::move(movedExpr.getHead()), std::move(args)); //
//   NOLINT CHECK(get<boss::ComplexExpression>(expr2.getArguments().at(0)) == "howdie"_());
...
//                            // Any modification/move of args will be reflected in expr's
//                            arguments!
...
//   // CHECK(get<int64_t>(expr.getArguments().at(1)) == 1); // fails because args was moved (see
//   TODO) CHECK(get<int32_t>(expr2.getArguments().at(1)) == 2);
// }
...
//     CHECK(
//         output ==
//         "Table"_("L_QUANTITY"_("List"_(17, 21, 8, 5)),                                    //
//         NOLINT
//                  "L_EXTENDEDPRICE"_("List"_(17954.55, 34850.16, 7712.48, 25284.00)),      //
//                  NOLINT "disc_price"_("List"_(17954.55 * (1.0 - 0.10), 34850.16 * (1.0 - 0.05),
//                  // NOLINT
//                                        7712.48 * (1.0 - 0.06), 25284.00 * (1.0 - 0.06))), //
//                                        NOLINT
//                  "charge"_("List"_(17954.55 * (1.0 - 0.10) * (0.02 + 1.0),                //
//                  NOLINT
//                                    34850.16 * (1.0 - 0.05) * (0.06 + 1.0),                //
//                                    NOLINT 7712.48 * (1.0 - 0.06) * (0.02 + 1.0), // NOLINT
//                                    25284.00 * (1.0 - 0.06) * (0.06 + 1.0))),              //
//                                    NOLINT
//                  "L_DISCOUNT"_("List"_(0.10, 0.05, 0.06, 0.06))));                        //
//                  NOLINT
//   }
...
//                                      7712.48 * (1.0 - 0.06), 25284.00 * (1.0 - 0.06))),   //
//                                      NOLINT
//                    "Column"_("calc"_, "List"_(17954.55 * (1.0 - 0.10) * (0.02 + 1.0),     //
//                    NOLINT
//                                               34850.16 * (1.0 - 0.05) * (0.06 + 1.0),     //
//                                               NOLINT 7712.48 * (1.0 - 0.06) * (0.02 + 1.0), //
//                                               NOLINT 25284.00 * (1.0 - 0.06) * (0.06 + 1.0)))));
//                                               // NOLINT
//   }
...
//                              "List"_(17954.55 * (1.0 - 0.10) * (0.02 + 1.0) +             //
//                              NOLINT
//                                          34850.16 * (1.0 - 0.05) * (0.06 + 1.0),          //
//                                          NOLINT
...
//                                          25284.00 * (1.0 - 0.06) * (0.06 + 1.0))),        //
//                                          NOLINT
//                    "Column"_("AVG_PRICE"_, "List"_((17954.55 + 34850.16) / 2,             //
//                    NOLINT
//                                                    (7712.48 + 25284.00) / 2)),            //
//                                                    NOLINT
//                    "Column"_("AVG_DISC"_, "List"_((0.10 + 0.05) / 2, (0.06 + 0.06) / 2)), //
//                    NOLINT "Column"_("COUNT_ORDER"_, "List"_(2, 2)))); // NOLINT
//   }
...
TEST_CASE("Lazy Expression Serialization With Spans") {
