...
: see instructions
If you are using the Wolfram engine, you first have to authenticate to Wolfram.
...
: cmake -DRacket_ROOT="/usr" -DCMAKE_CXX_FLAGS:STRING="-std=c++17" -DCMAKE_CXX_COMPILER:STRING=clang++-11 -DCMAKE_BUILD_TYPE=Debug ..
: OR
: cmake -DRacket_ROOT="/usr" -DCMAKE_CXX_FLAGS:STRING="-std=c++17" -DCMAKE_CXX_COMPILER:STRING=clang++-11 -DCMAKE_BUILD_TYPE=Release ..
: OR
: cmake -DRacket_ROOT="/usr" -DCMAKE_CXX_FLAGS:STRING="-std=c++17" -DCMAKE_CXX_COMPILER:STRING=clang++-11 -DCMAKE_BUILD_TYPE=RelWithDebInfo ..
