...
"
   ...
   '(list
     (li (a ((href "legacy/Customer/:/Project/:/As/Name/FirstName/Last/LastName/Age/age")) "Simple Projection Query - Customer table"))
     (li (a ((href "legacy/NumbersTable/:/Project/:/As/x/xnumber/y/ynumber/desc/description")) "Simple Projection Query - XY table"))
