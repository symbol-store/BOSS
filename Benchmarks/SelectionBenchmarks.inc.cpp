...
static void SymbolSelection95(benchmark::State& state) {
  new_runtime::Relation relation;
...
BENCHMARK(SymbolSelection95)->Unit(benchmark::kMillisecond)->Arg(5)->Arg(50)->Arg(500)->Arg(5000)->Arg(50000)->Arg(500000);
